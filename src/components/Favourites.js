...
function Favourites() {
  ...
  // for getting favourite movies from the local storage 
  useEffect(() => {
  ...
  // filtered movies according to genres
  
  // agar currGenres equals all genres toh jo bhi saari movies hai
  //  favourites mein vo show kardo nhi toh genres ke according  filter karke show kardo 
                  ...
                  >
                    <div className='flex'>
                      <img src='https://img.icons8.com/external-those-icons-lineal-those-icons/24/000000/external-up-arrows-those-icons-lineal-those-icons-3.png'
                       className='mr-2 cursor-pointer' alt='img'
                        onClick={() => {
                          setPopularity(0)
                          setRating(-1)
                        }}
